                    ...
                    <div class="post-footer">
                        ...
                        <div class="post-actions">
                            <div class="likes d-inline">
                                <b-button variant="outline-light" @click="makeToast('light')"><b-avatar class="mr-1 align-top" variant="light" src="https://img.icons8.com/ios/24/000000/like--v1.png" size="1.4rem"></b-avatar><span>246</span></b-button>
                            </div>
                            <div class="comments d-inline">
                                <b-button variant="outline-light"><b-avatar class="mr-1 align-top" variant="light" src="https://img.icons8.com/ios/24/000000/topic.png" size="1.4rem"></b-avatar><span>32</span></b-button>
                            </div>
                        </div>
                    </div>
